...
def load_data(file_name, sequence_length=10, split=0.8):
    df = pd.read_csv(file_name, sep=';', usecols=[3],converters={'Global_reactive_power': p2f})
...
if __name__ == '__main__':
    train_x, train_y, test_x, test_y, scaler = load_data('household_power_consumption-5k.csv')
